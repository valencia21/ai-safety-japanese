...
export const ReadingList: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <div className="reading-layout relative border-t border-stone-900">
        <div className="reading-grid divide-stone-900">
          <div className="reading-sidebar relative p-8 border-b border-stone-900">
          ...
          <div className="reading-content">
            <div className="reading-items-grid relative">
              {readings.map((reading) => (
                <div
                  key={reading.content_id}
                  className="reading-item group border-b border-stone-900 relative"
                >
